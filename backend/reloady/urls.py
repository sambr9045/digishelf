...
def get_giftcard_url(productName, countryCode=""):
    return f"https://giftcards-sandbox.reloadly.com/products?size=&page=&productName={productName}&countryCode={countryCode}&includeRange=true&includeFixed=true&sorted=true"
...
def search_giftcar(country, name=None):
   if country:
       return f" https://giftcards-sandbox.reloadly.com/countries/{country}/products"